...
export function ClockInOut() {
  ...
  const clockInMutation = useMutation({
    mutationFn: () =>
      apiRequest("POST", "https://laundry-be-admin.onrender.com/api/attendance/clock-in", {
  ...
  const clockOutMutation = useMutation({
    mutationFn: () =>
      apiRequest(
        "POST",
        `https://laundry-be-admin.onrender.com/api/attendance/clock-out/${(todayAttendance as AttendanceRecord)?.id}`,
        {},
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/attendance"] });
  ...
  const breakStartMutation = useMutation({
    mutationFn: () =>
      apiRequest(
        "POST",
        `https://laundry-be-admin.onrender.com/api/attendance/break-start/${(todayAttendance as AttendanceRecord)?.id}`,
        {},
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/attendance"] });
  ...
  const breakEndMutation = useMutation({
    mutationFn: () =>
      apiRequest(
        "POST",
        `https://laundry-be-admin.onrender.com/api/attendance/break-end/${(todayAttendance as AttendanceRecord)?.id}`,
        {},
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/attendance"] });
