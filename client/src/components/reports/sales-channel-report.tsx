...
export function SalesChannelReport() {
  ...
  const { data: salesChannelSalesData, isLoading: salesLoading } = useQuery({
    queryKey: [
      "https://laundry-be-admin.onrender.com/api/sales-channel-sales",
      startDate,
      endDate,
      selectedSeller,
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/sales-channel-sales?${params}`);
      if (!response.ok) {
  ...
  const { data: salesChannelProfitData, isLoading: profitLoading } = useQuery({
    queryKey: [
      "https://laundry-be-admin.onrender.com/api/sales-channel-profit",
      startDate,
      endDate,
      selectedSeller,
      selectedSalesChannel,
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/sales-channel-profit?${params}`);
      if (!response.ok) {
  ...
  const { data: salesChannelProductsData, isLoading: productsLoading } =
    useQuery({
      queryKey: [
        "https://laundry-be-admin.onrender.com/api/sales-channel-products",
        startDate,
        endDate,
        selectedSeller,
        selectedSalesChannel,
      ...
      queryFn: async () => {
        ...
        const response = await fetch(`https://laundry-be-admin.onrender.com/api/sales-channel-products?${params}`);
        if (!response.ok) {
