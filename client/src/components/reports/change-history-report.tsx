...
export function ChangeHistoryReport() {
  ...
  const {
    ...
    queryKey: ["https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/order-change-history", startDate, endDate, storeFilter],
    queryFn: async () => {
      try {
        ...
        console.log("📋 Fetching change history with params:", {
          ...
          endDate,
          storeFilter,
          url: `https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/order-change-history?${params}`,
        });

        const response = await fetch(`https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/order-change-history?${params}`);
        if (!response.ok) {
