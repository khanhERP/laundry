...
export function TableReport() {
  ...
  const { data: orders = [], isLoading: ordersLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch(`https://laundry-be-admin.onrender.com/api/orders/date-range/${startDate}/${endDate}/all`);
        if (!response.ok) {
  ...
  const { data: invoices = [], isLoading: invoicesLoading } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/invoices"],
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/invoices");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: transactions = [], isLoading: transactionsLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/transactions");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: tables = [], isLoading: tablesLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/tables");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: transactionItems = [], isLoading: transactionItemsLoading } =
    useQuery({
      queryKey: ["https://laundry-be-admin.onrender.com/api/transaction-items"],
      queryFn: async () => {
        try {
          const response = await fetch("https://laundry-be-admin.onrender.com/api/transaction-items");
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
          const data = await response.json();
