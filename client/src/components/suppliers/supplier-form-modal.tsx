...
export function SupplierFormModal({ isOpen, onClose, supplier }: SupplierFormModalProps) {
  ...
  useEffect(() => {
    const fetchNextCode = async () => {
      if (!supplier && isOpen) {
        try {
          const response = await apiRequest('GET', 'https://laundry-be-admin.onrender.com/api/suppliers/next-code');
  ...
  const createMutation = useMutation({
    mutationFn: async (data: InsertSupplier) => {
      const response = await apiRequest('POST', 'https://laundry-be-admin.onrender.com/api/suppliers', data);
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: Partial<InsertSupplier>) => {
      const response = await apiRequest('PUT', `https://laundry-be-admin.onrender.com/api/suppliers/${supplier!.id}`, data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://laundry-be-admin.onrender.com/api/suppliers'] });
