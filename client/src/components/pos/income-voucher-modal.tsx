...
export default function IncomeVoucherModal({
  ...
  const createVoucherMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/income-vouchers"] });
  ...
  const updateVoucherMutation = useMutation({
    mutationFn: async (data: IncomeVoucher) => {
      ...
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/income-vouchers/${data.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(data),
      });
  ...
  const deleteVoucherMutation = useMutation({
    mutationFn: async (id: string) => {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/income-vouchers/${id}`, {
        method: "DELETE",
      });
