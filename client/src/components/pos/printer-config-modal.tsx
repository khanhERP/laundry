...
export function PrinterConfigModal({
  ...
  const { data: printerConfigs = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/printer-configs");
  ...
  const createConfigMutation = useMutation({
    mutationFn: async (configData: any) => {
      const response = await apiRequest(
        "POST",
        "https://laundry-be-admin.onrender.com/api/printer-configs",
        configData,
      );
      return response.json();
    },
    onSuccess: () => {
      ...
      queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/printer-configs"] });
  ...
  const updateConfigMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/printer-configs/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const testConnectionMutation = useMutation({
    mutationFn: async (id: number) => {
      const response = await apiRequest(
        "POST",
        `https://laundry-be-admin.onrender.com/api/printer-configs/${id}/test`,
      );
      return response.json();
    },
    onSuccess: (data) => {
