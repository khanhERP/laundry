  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      if (receiptData.orderId && receiptData.orderId !== 'temp-order') {
        ...
        try {
          const statusResponse = await fetch(`https://laundry-be-admin.onrender.com/api/orders/${receiptData.orderId}/status`, {
            method: 'PUT',
            headers: {
      ...
      try {
        ...
        const printApiResponse = await fetch('https://laundry-be-admin.onrender.com/api/pos/print-receipt', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              onClick={() => {
                ...
                try {
                  fetch('https://laundry-be-admin.onrender.com/api/popup/close', {
                    method: 'POST',
                    headers: {
                      'Content-Type': 'application/json',
                    },
