...
export function EInvoiceModal({
  ...
  const completePaymentMutation = useMutation({
    mutationFn: ({
      ...
      return apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/orders/${orderId}/status`, {
        status: "paid",
  ...
  const { data: invoiceTemplates = [] } = useQuery<any[]>({
    queryKey: ["https://laundry-be-admin.onrender.com/api/invoice-templates/active"],
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/invoice-templates/active");
        if (!response.ok) {
  ...
  const { data: orderData } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/orders", orderId],
    queryFn: async () => {
      if (!orderId) return null;
      try {
        const response = await apiRequest("GET", `https://laundry-be-admin.onrender.com/api/orders/${orderId}`);
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
  ...
  const handleGetTaxInfo = async () => {
    ...
    try {
      ...
      const response = await fetch("https://laundry-be-admin.onrender.com/api/tax-code-lookup", {
        method: "POST",
        headers: {
  ...
  const handlePublishLater = async (event?: React.MouseEvent) => {
    ...
    try {
      ...
      // Lưu hóa đơn vào bảng invoices và invoice_items
      const invoiceResponse = await fetch("https://laundry-be-admin.onrender.com/api/invoices", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (orderId) {
        try {
          ...
          const updateResponse = await fetch(`https://laundry-be-admin.onrender.com/api/orders/${orderId}`, {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
  ...
  const handleConfirm = async (event?: React.MouseEvent) => {
    ...
    // Call the proxy API
    const response = await fetch("https://laundry-be-admin.onrender.com/api/einvoice/publish", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (result.success) {
      ...
      if (orderId) {
        ...
        try {
          ...
          const saveResponse = await fetch("https://laundry-be-admin.onrender.com/api/orders", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
      ...
      try {
        const transactionResponse = await fetch("https://laundry-be-admin.onrender.com/api/transactions", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
