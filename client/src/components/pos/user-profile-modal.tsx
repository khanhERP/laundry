...
export function UserProfileModal({ isOpen, onClose }: UserProfileModalProps) {
  ...
  const updateUserMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/users/${userInfo.userId}`, {
        method: "PUT",
        headers: {
    ...
    onSuccess: (data) => {
      ...
      setIsEditing(false);
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/users"] });
    },
    onError: (error) => {
      toast({
        title: "Lỗi",
