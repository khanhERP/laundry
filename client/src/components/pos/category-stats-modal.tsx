...
export function CategoryStatsModal({ isOpen, onClose }: CategoryStatsModalProps) {
  ...
  const { data: productsData } = useQuery<any[]>({
    queryKey: ["https://laundry-be-admin.onrender.com/api/products", { includeInactive: true }],
    queryFn: async () => {
      const response = await fetch("https://laundry-be-admin.onrender.com/api/products?includeInactive=true");
