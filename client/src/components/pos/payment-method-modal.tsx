  ...
  const handleSelect = async (method: string) => {
    ...
    if (method === "cash") {
      ...
      if (isTemporaryOrder) {
        ...
        const createResponse = await fetch("https://laundry-be-admin.onrender.com/api/orders", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        try {
          ...
          const updateResponse = await fetch(`https://laundry-be-admin.onrender.com/api/orders/${orderInfo.id}`, {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
          ...
          if (updateResponse.ok) {
            ...
            if (updatedOrder.tableId) {
              ...
              try {
                ...
                const ordersResponse = await fetch("https://laundry-be-admin.onrender.com/api/orders", {
                  method: "GET",
                  headers: {
                    "Content-Type": "application/json",
                  },
                ...
                if (otherActiveOrders.length === 0) {
                  ...
                  const tableUpdateResponse = await fetch(
                    `https://laundry-be-admin.onrender.com/api/tables/${updatedOrder.tableId}/status`,
                    {
                      method: "PUT",
                      headers: {
                        "Content-Type": "application/json",
  ...
  const handleQRComplete = async () => {
    ...
    if (isTemporaryOrder) {
      ...
      try {
        ...
        const statusResponse = await fetch(`https://laundry-be-admin.onrender.com/api/orders/${orderInfo.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
          ...
          if (data.tableId) {
            ...
            try {
              ...
              if (ordersResponse.ok) {
                ...
                if (otherActiveOrders.length === 0) {
                  const tableUpdateResponse = await fetch(
                    `https://laundry-be-admin.onrender.com/api/tables/${data.tableId}/status`,
                    {
                      method: "PUT",
                      headers: {
                        "Content-Type": "application/json",
