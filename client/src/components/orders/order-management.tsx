...
export function OrderManagement() {
  ...
  const { data: orders, isLoading: ordersLoading } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/orders", "table"],
    ...
    queryFn: async () => {
      const response = await apiRequest(
        "GET",
        "https://laundry-be-admin.onrender.com/api/orders?salesChannel=table",
      );
      if (!response.ok) {
  ...
  const { data: orderItems, isLoading: orderItemsLoading } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", selectedOrder?.id],
    ...
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest(
          "GET",
          `https://laundry-be-admin.onrender.com/api/order-items/${selectedOrder.id}`,
        );
        if (!response.ok) {
          console.error(
  ...
  const updateOrderStatusMutation = useMutation({
    mutationFn: ({ orderId, status }: { orderId: number; status: string }) =>
      apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/orders/${orderId}/status`, { status }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] });
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
      toast({
  ...
  const completeOrderPayment = async (orderId: number, paymentData: any) => {
    ...
    try {
      ...
      console.log("🔍 API Call Details:", {
        url: `https://laundry-be-admin.onrender.com/api/orders/${orderId}/status`,
        method: "PUT",
      ...
      const paymentDetailsResponse = await fetch(`https://laundry-be-admin.onrender.com/api/orders/${orderId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
