...
export function CustomerFormModal({
  ...
  const { data: orderHistory, isLoading: ordersLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest("GET", `https://laundry-be-admin.onrender.com/api/orders`);
  ...
  const generateCustomerId = async () => {
    try {
      const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/customers/next-id");
  ...
  const createMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      const response = await apiRequest("POST", "https://laundry-be-admin.onrender.com/api/customers", data);
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      ...
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/customers/${customer.id}`,
        data,
      );
      return response.json();
    },
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    if (
      ...
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/customers/next-id");
