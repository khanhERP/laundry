...
export function CustomerPointsModal({
  ...
  const { data: pointsData, isLoading: pointsLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/customers/${customerId}/points`);
  ...
  const { data: pointHistory, isLoading: historyLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/customers/${customerId}/point-history`);
