...
export function TableManagement() {
  ...
  const createTableMutation = useMutation({
    mutationFn: (data: TableFormData) =>
      apiRequest("POST", "https://laundry-be-admin.onrender.com/api/tables", data),
    onSuccess: () => {
  ...
  const updateTableMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: TableFormData }) =>
      apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/tables/${id}`, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
      toast({
        title: t("common.success"),
  ...
  const deleteTableMutation = useMutation({
    mutationFn: (id: number) => apiRequest("DELETE", `https://laundry-be-admin.onrender.com/api/tables/${id}`, {}),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
      toast({
        title: t("common.success"),
