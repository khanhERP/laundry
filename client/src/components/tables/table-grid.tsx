...
export function TableGrid({ onTableSelect, selectedTableId }: TableGridProps) {
  ...
  const {
    ...
    queryKey: ["https://laundry-be-admin.onrender.com/api/tables"],
  ...
  const {
    ...
    queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", selectedOrder?.id || "none"],
    ...
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest("GET", `https://laundry-be-admin.onrender.com/api/order-items/${orderId}`);
  ...
  useEffect(() => {
    if (orderDetailsOpen && selectedOrder?.id) {
      const cachedData = queryClient.getQueryData([
        "https://laundry-be-admin.onrender.com/api/order-items",
        selectedOrder.id,
      ]);
      if (!cachedData) {
        console.log(
    ...
    const handleOrderUpdate = (event: CustomEvent) => {
      ...
      if (!event.detail?.skipAllRefetch && event.detail?.orderId) {
        queryClient.invalidateQueries({
          queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", event.detail.orderId],
        });
      }
    };
            ...
            try {
              ...
              for (const order of tableOrders) {
                ...
                const response = await apiRequest(
                  "GET",
                  `https://laundry-be-admin.onrender.com/api/order-items/${order.id}`,
                );
  ...
  const updateTableStatusMutation = useMutation({
    mutationFn: ({ tableId, status }: { tableId: number; status: string }) =>
      apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/tables/${tableId}/status`, { status }),
    onSuccess: async (data, variables) => {
      ...
      queryClient.removeQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
      queryClient.removeQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] });
  ...
  const completePaymentMutation = useMutation({
    mutationFn: ({
      ...
      apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/orders/${orderId}/status`, {
        status: "paid",
        paymentMethod,
      }),
    onSuccess: async (data, variables) => {
        ...
        try {
          ...
          if (otherActiveOrders.length === 0) {
            ...
            try {
              await apiRequest(
                "PUT",
                `https://laundry-be-admin.onrender.com/api/tables/${completedOrder.tableId}/status`,
                {
                  status: "available",
                },
              );
      ...
      try {
        ...
        const [freshTables, freshOrders] = await Promise.all([
          fetch("https://laundry-be-admin.onrender.com/api/tables", {
            cache: "no-store",
            headers: { "Cache-Control": "no-cache" },
          }).then((r) => r.json()),
          fetch("https://laundry-be-admin.onrender.com/api/orders", {
            cache: "no-store",
            headers: { "Cache-Control": "no-cache" },
          }).then((r) => r.json()),
        ]);
        ...
        queryClient.setQueryData(["https://laundry-be-admin.onrender.com/api/tables"], freshTables);
        queryClient.setQueryData(["https://laundry-be-admin.onrender.com/api/orders"], freshOrders);
      ...
      try {
        const [completedOrder, orderItemsData] = await Promise.all([
          queryClient.fetchQuery({
            queryKey: ["https://laundry-be-admin.onrender.com/api/orders", variables.orderId],
            queryFn: async () => {
              const response = await apiRequest(
                "GET",
                `https://laundry-be-admin.onrender.com/api/orders/${variables.orderId}`,
              );
              return response.json();
            },
          }),
          queryClient.fetchQuery({
            queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", variables.orderId],
            queryFn: async () => {
              const response = await apiRequest(
                "GET",
                `https://laundry-be-admin.onrender.com/api/order-items/${variables.orderId}`,
              );
              return response.json();
            },
          }),
  ...
  const pointsPaymentMutation = useMutation({
    mutationFn: async ({
      ...
      // First redeem points
      await apiRequest("POST", "https://laundry-be-admin.onrender.com/api/customers/redeem-points", {
        customerId,
        points,
      });

      // Then mark order as paid
      await apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/orders/${orderId}/status`, {
        status: "paid",
    ...
    onSuccess: async (data, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] });
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/customers"] });
      queryClient.invalidateQueries({
        queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", variables.orderId],
      });
      setOrderDetailsOpen(false);
  ...
  const deleteOrderMutation = useMutation({
    mutationFn: async (orderId: number) => {
      ...
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/orders/${orderId}/status`,
        { status: "cancelled" },
      );
      ...
      if (order?.tableId) {
        ...
        if (!otherActiveOrders || otherActiveOrders.length === 0) {
          await apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/tables/${order.tableId}/status`, {
            status: "available",
          });
        }
      }
    ...
    onSuccess: (data, orderId) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
      queryClient.invalidateQueries({
        queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", orderId],
  ...
  const recalculateOrderTotalMutation = useMutation({
    mutationFn: async (orderId: number) => {
      ...
      if (!remainingItems || remainingItems.length === 0) {
        ...
        const updateResult = await apiRequest("PUT", `https://laundry-be-admin.onrender.com/api/orders/${orderId}`, {
          subtotal: "0",
          tax: "0",
          total: "0",
        });
    ...
    onSuccess: (data, orderId) => {
      ...
      Promise.all([
        fetch("https://laundry-be-admin.onrender.com/api/orders", { cache: "no-store" }).then((r) => r.json()),
        fetch("https://laundry-be-admin.onrender.com/api/tables", { cache: "no-store" }).then((r) => r.json()),
        fetch(`https://laundry-be-admin.onrender.com/api/order-items/${orderId}`, { cache: "no-store" }).then((r) =>
          r.json(),
        ),
      ])
        .then(() => {
          ...
          queryClient.setQueryData(["https://laundry-be-admin.onrender.com/api/orders"], (oldData: any) => {
  ...
  const handlePaymentMethodSelect = async (
    ...
    if (method === "paymentCompleted" && paymentData?.success) {
      ...
      try {
        ...
        const [freshTables, freshOrders] = await Promise.all([
          fetch(
            "https://laundry-be-admin.onrender.com/api/tables?" +
              new URLSearchParams({
          ...
          fetch(
            "https://laundry-be-admin.onrender.com/api/orders?" +
              new URLSearchParams({
                _t: Date.now().toString(),
                _force: "true",
              }),
        ...
        setTimeout(() => {
          queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
          queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] });
        }, 200);
  ...
  const handleReceiptConfirm = async () => {
    ...
    try {
      ...
      try {
        ...
        const wsUrl = `https://laundry-be-admin.onrender.com/ws`;
    ...
    try {
      ...
      if (currentOrderId) {
        try {
          const response = await apiRequest(
            "GET",
            `https://laundry-be-admin.onrender.com/api/order-items/${currentOrderId}`,
          );
  ...
  const handlePrintOrder = async (order: any) => {
    ...
    try {
      const orderItems = await queryClient.fetchQuery({
        queryKey: [`https://laundry-be-admin.onrender.com/api/order-items/${order.id}`],
        queryFn: async () => {
          const response = await apiRequest(
            "GET",
            `https://laundry-be-admin.onrender.com/api/order-items/${order.id}`,
      ...
      const response = await fetch("https://laundry-be-admin.onrender.com/api/auto-print", {
        method: "POST",
        headers: {
  ...
  const splitOrderMutation = useMutation({
    mutationFn: async (splitData: {
      ...
      const response = await apiRequest("POST", "https://laundry-be-admin.onrender.com/api/orders/split", {
      ...
      await Promise.all([
        ...
        refetchTables(),
        queryClient.invalidateQueries({
          queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", splitData.originalOrderId],
        }),
      ]);
  ...
  const handleSplitOrder = async (splitData: any) => {
    try {
      ...
      const response = await apiRequest("POST", "https://laundry-be-admin.onrender.com/api/orders/split", splitData);
      ...
      <OrderDialog
        ...
        onOpenChange={(open) => {
          ...
          if (!open && editingOrder) {
            ...
            queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] });
            queryClient.invalidateQueries({
              queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", editingOrder.id],
            });
