  ...
  const updateOrderMutation = useMutation({
    mutationFn: async (updatedOrder: Order) => {
      ...
      const itemsResponse = await apiRequest(
        "GET",
        `https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/order-items/${updatedOrder.id}`,
      );
    ...
    mutationFn: async (orderIds: string[]) => {
      ...
      for (const orderId of orderIds) {
        try {
          ...
          await apiRequest(
            "POST",
            "https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/order-change-history",
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      ...
      const orderUpdateResponse = await apiRequest(
        "PUT",
        `https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/orders/${editableInvoice.id}`,
        orderUpdatePayload,
      );
