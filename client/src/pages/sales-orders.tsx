...
export default function SalesOrders() {
  ...
  useEffect(() => {
    ...
    const handleEInvoiceModalClosed = async (event: CustomEvent) => {
      ...
      queryClient.removeQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/order-items"] });
      queryClient.removeQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/invoices"] });

      // Force immediate refetch with fresh data
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] }),
        queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/order-items"] }),
        queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/invoices"] }),
        queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/tables"] }),
        queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] }),
        queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/invoices"] }),
      ]);
  ...
  useEffect(() => {
    const handleOrderUpdate = async () => {
      ...
      await queryClient.refetchQueries({
        queryKey: ["https://laundry-be-admin.onrender.com/api/orders/list"],
        exact: false,
      });
    };
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/store-settings");
        if (!response.ok) {
  ...
  const { data: customers = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/customers");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const {
    ...
    queryKey: [
      "https://laundry-be-admin.onrender.com/api/orders/list",
      startDate,
      endDate,
      dateFilterMode,
      customerSearch,
    ...
    queryFn: async () => {
      try {
        ...
        const url = `https://laundry-be-admin.onrender.com/api/orders/list?${params.toString()}`;
  ...
  const { data: products = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/products");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: tables = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/tables");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const {
    ...
    queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", selectedInvoice?.id],
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest(
          "GET",
          `https://laundry-be-admin.onrender.com/api/order-items/${selectedInvoice.id}`,
        );
  ...
  const updateOrderMutation = useMutation({
    mutationFn: async (updatedOrder: Order) => {
      ...
      const itemsResponse = await apiRequest(
        "GET",
        `https://laundry-be-admin.onrender.com/api/order-items/${updatedOrder.id}`,
      );
      ...
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/orders/${updatedOrder.id}`,
        updatePayload,
      );
    ...
    onSuccess: async (data, updatedOrder) => {
      ...
      await queryClient.refetchQueries({
        queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", updatedOrder.id],
      });
  ...
  const bulkCancelOrdersMutation = useMutation({
    mutationFn: async (orderIds: string[]) => {
      ...
      for (const orderId of orderIds) {
        try {
          ...
          await apiRequest(
            "POST",
            "https://laundry-be-admin.onrender.com/api/order-change-history",
    ...
    onSuccess: (results) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders/list"] });
  ...
  const publishRequestMutation = useMutation({
    mutationFn: async (invoiceData: any) => {
      const response = await apiRequest(
        "POST",
        "https://laundry-be-admin.onrender.com/api/einvoice/publish",
        invoiceData,
      );
      return response.json();
    },
      ...
      if (result.success && selectedInvoice) {
        try {
          ...
          const updateResponse = await apiRequest(
            "PUT",
            `https://laundry-be-admin.onrender.com/api/orders/${selectedInvoice.id}`,
            updateData,
          );
          console.log(
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      ...
      for (const item of itemsToDelete) {
        ...
        const response = await apiRequest(
          "DELETE",
          `https://laundry-be-admin.onrender.com/api/order-items/${item.id}`,
        );
        if (!response.ok) {
      ...
      for (const item of itemsToCreate) {
        ...
        const response = await apiRequest(
          "POST",
          `https://laundry-be-admin.onrender.com/api/order-items/${editableInvoice.id}`,
          payload,
        );
      ...
      const orderUpdateResponse = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/orders/${editableInvoice.id}`,
        orderUpdatePayload,
      );
      ...
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders"] }),
        queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/orders/list"] }),
        queryClient.refetchQueries({
          queryKey: ["https://laundry-be-admin.onrender.com/api/order-items", editableInvoice.id],
        }),
        queryClient.refetchQueries({
          queryKey: [
            "https://laundry-be-admin.onrender.com/api/orders/date-range",
            startDate,
            endDate,
            currentPage,
            itemsPerPage,
  ...
  const { data: paymentMethodsData = [] } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/payment-methods"],
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://laundry-be-admin.onrender.com/api/payment-methods");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const handlePayment = async (order: Invoice) => {
    ...
    try {
      const updateResponse = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/orders/${order.id}`,
        {
          paymentStatus: "paid",
          status: "paid",
  ...
  const handlePrintReceipt = async (order: any) => {
    try {
      ...
      const response = await apiRequest("GET", `https://laundry-be-admin.onrender.com/api/order-items/${order.id}`);
