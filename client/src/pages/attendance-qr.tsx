...
export default function AttendanceQRPage() {
  ...
  const { data: todayAttendance, refetch: refetchTodayAttendance } = useQuery({
    queryKey: ['https://laundry-be-admin.onrender.com/api/attendance/today', selectedEmployeeId],
    enabled: !!selectedEmployeeId,
  });

  const clockInMutation = useMutation({
    mutationFn: () => apiRequest('POST', 'https://laundry-be-admin.onrender.com/api/attendance/clock-in', {
      employeeId: parseInt(selectedEmployeeId),
      notes
    }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://laundry-be-admin.onrender.com/api/attendance'] });
  ...
  const clockOutMutation = useMutation({
    mutationFn: () => apiRequest('POST', `https://laundry-be-admin.onrender.com/api/attendance/clock-out/${(todayAttendance as AttendanceRecord)?.id}`, {}),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://laundry-be-admin.onrender.com/api/attendance'] });
      refetchTodayAttendance();
      toast({
  ...
  const breakStartMutation = useMutation({
    mutationFn: () => apiRequest('POST', `https://laundry-be-admin.onrender.com/api/attendance/break-start/${(todayAttendance as AttendanceRecord)?.id}`, {}),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://laundry-be-admin.onrender.com/api/attendance'] });
      refetchTodayAttendance();
      toast({
  ...
  const breakEndMutation = useMutation({
    mutationFn: () => apiRequest('POST', `https://laundry-be-admin.onrender.com/api/attendance/break-end/${(todayAttendance as AttendanceRecord)?.id}`, {}),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://laundry-be-admin.onrender.com/api/attendance'] });
      refetchTodayAttendance();
      toast({
