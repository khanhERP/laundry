...
export default function SettingsPage({ onLogout }: SettingsPageProps) {
  ...
  const confirmDeleteEmployee = async () => {
    ...
    try {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/employees/${employeeToDelete.id}`, {
        method: "DELETE",
      });
      ...
      await queryClient.refetchQueries({
        queryKey: ["https://laundry-be-admin.onrender.com/api/employees"],
      });
  ...
  const { data: printers = [], isLoading: printersLoading } = useQuery<
    Printer[]
  >({
    queryKey: ["https://laundry-be-admin.onrender.com/api/printers"],
  });

  // Fetch dynamic product units from the API
  const { data: productUnits = [] } = useQuery<string[]>({
    queryKey: ["https://laundry-be-admin.onrender.com/api/products/units"],
  });
  ...
  const updateStoreSettingsMutation = useMutation({
    mutationFn: async (settings: Partial<InsertStoreSettings>) => {
      const response = await apiRequest("PUT", "https://laundry-be-admin.onrender.com/api/store-settings", settings);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/store-settings"] });
      toast({
  ...
  const createPaymentMethodMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest("POST", "https://laundry-be-admin.onrender.com/api/payment-methods", data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/payment-methods"] });
      toast({
        title: t("common.success"),
  ...
  const updatePaymentMethodMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/payment-methods/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const deletePaymentMethodMutation = useMutation({
    mutationFn: async (id: number) => {
      const response = await apiRequest("DELETE", `https://laundry-be-admin.onrender.com/api/payment-methods/${id}`);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/payment-methods"] });
  ...
  const confirmDeleteCustomer = async () => {
    ...
    try {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/customers/${customerToDelete.id}`, {
        method: "DELETE",
      });
      ...
      await queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/customers"] });
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      const response = await fetch("https://laundry-be-admin.onrender.com/api/categories", {
        method: "POST",
        headers: {
      ...
      await queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/categories"] });
      await queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/products"] });
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/categories/${editingCategory.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const confirmDeleteCategory = async () => {
    ...
    try {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/categories/${categoryToDelete.id}`, {
        method: "DELETE",
      });
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/products/${editingProduct.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(finalProductData),
      });
  ...
  const confirmDeleteProduct = async () => {
    ...
    try {
      await apiRequest("DELETE", `https://laundry-be-admin.onrender.com/api/products/${productToDelete.id}`);
  ...
  const { data: eInvoiceConnections = [], isLoading: eInvoiceLoading } =
    useQuery<any[]>({
      queryKey: ["https://laundry-be-admin.onrender.com/api/einvoice-connections"],
    });
  ...
  const createEInvoiceMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest(
        "POST",
        "https://laundry-be-admin.onrender.com/api/einvoice-connections",
        data,
      );
      return response.json();
    },
  ...
  const updateEInvoiceMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/einvoice-connections/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const { data: invoiceTemplates = [], isLoading: templatesLoading } = useQuery<
    any[]
  >({
    queryKey: ["https://laundry-be-admin.onrender.com/api/invoice-templates"],
  });

  // Invoice template mutations
  const createTemplateMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await apiRequest("POST", "https://laundry-be-admin.onrender.com/api/invoice-templates", data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/invoice-templates"] });
      toast({
        title: t("common.success"),
  ...
  const updateTemplateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: any }) => {
      const response = await apiRequest(
        "PUT",
        `https://laundry-be-admin.onrender.com/api/invoice-templates/${id}`,
        data,
      );
      return response.json();
    },
  ...
  const refetchProducts = () => {
    queryClient.invalidateQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/products"] });
  };
