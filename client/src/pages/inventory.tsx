...
export default function InventoryPage({ onLogout }: InventoryPageProps) {
  ...
  const updateStockMutation = useMutation({
    mutationFn: async (data: StockUpdateForm) => {
      ...
      const response = await fetch("https://laundry-be-admin.onrender.com/api/inventory/update-stock", {
        method: "POST",
        headers: {
    ...
    onSuccess: () => {
      ...
      queryClient.refetchQueries({ queryKey: ["https://laundry-be-admin.onrender.com/api/products"] });
  ...
  const updateProductTrackInventoryMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/products/${id}/track-inventory`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteProductMutation = useMutation({
    mutationFn: async (productId: number) => {
      const response = await fetch(`https://laundry-be-admin.onrender.com/api/products/${productId}`, {
        method: "DELETE",
      });
      if (!response.ok) {
  ...
  const cleanupMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch("https://laundry-be-admin.onrender.com/api/products/cleanup/inactive", {
        method: "DELETE",
      });
      if (!response.ok) {
