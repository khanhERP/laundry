...
export default function PurchasesPage({ onLogout }: PurchasesPageProps) {
  ...
  const {
    ...
    queryKey: [
      "https://laundry-be-admin.onrender.com/api/purchase-receipts",
      {
        startDate,
        endDate,
        productFilter,
    ...
    queryFn: async () => {
      ...
      const url = `https://laundry-be-admin.onrender.com/api/purchase-receipts${params.toString() ? `?${params.toString()}` : ""}`;
  ...
  const bulkDeleteMutation = useMutation({
    mutationFn: async (orderIds: number[]) => {
      return apiRequest("POST", "https://laundry-be-admin.onrender.com/api/purchase-receipts/bulk-delete", {
        orderIds,
      });
    },
    onSuccess: (data) => {
