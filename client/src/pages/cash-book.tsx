...
export default function CashBookPage({ onLogout }: CashBookPageProps) {
  ...
  const { data: generalSettings = [] } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/general-settings"],
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/general-settings");
        if (!response.ok)
  ...
  const { data: orders = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/orders");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: purchaseReceipts = [] } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/purchase-receipts"],
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/purchase-receipts");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
  ...
  const { data: incomeVouchers = [] } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/income-vouchers"],
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/income-vouchers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: expenseVouchers = [] } = useQuery({
    queryKey: ["https://laundry-be-admin.onrender.com/api/expense-vouchers"],
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/expense-vouchers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: suppliers = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-admin.onrender.com/api/suppliers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
