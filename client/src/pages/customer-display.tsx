  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        // Fetch store info
        const storeResponse = await fetch('https://laundry-be-admin.onrender.com/api/store-settings');
        if (storeResponse.ok) {
        ...
        const cartResponse = await fetch('https://laundry-be-admin.onrender.com/api/current-cart');
        if (cartResponse.ok) {
